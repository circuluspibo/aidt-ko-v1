    ...
    <>
      ...
      {(level !== "high" || absoluteWarnings.length > 0) && (
        ...
        <div className="text-sm">
          ...
          {!faceDetected && absoluteWarnings.length === 0 && (
...
export default ConcetrationAlert;
